...
public abstract class CertificateCoder {
   ...
   * @throws Exception
   */
  public static byte[] descryptByPrivateKey(byte[] data, String keyStorePath, String alias, String password)
      throws Exception {
    PrivateKey privateKey = getPrivateKeyByKeyStore(keyStorePath, alias, password);
    Cipher cipher = Cipher.getInstance(privateKey.getAlgorithm());
   ...
   * @throws Exception
   */
  public static byte[] descryptByPublicKey(byte[] data, String keyStorePath, String alias, String password)
      throws Exception {
    PublicKey publicKey = getPublicKeyByCertificate(keyStorePath);
    Cipher cipher = Cipher.getInstance(publicKey.getAlgorithm());
