...
public class MailSender {
   ...
   * 
   */
  protected void sendMailBySynchronizationMode(Map<String, Object> info) throws MessagingException {
    info.putAll(FreeMarkerTemplateUtils.getShareVars());
   ...
   * 
   */
  public void sendMail(String toAddress, String subject, Map<String, Object> info, String ftlName, boolean isAsync)
      throws MessagingException {
    info.putAll(FreeMarkerTemplateUtils.getShareVars());
