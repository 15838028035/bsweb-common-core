...
public interface UpmOrganizationService<UpmOrganization> extends BaseService {
	...
	/**
	 * query the list of orgnizations ,all were params orgid's parent.<br />include itself.
	 * @param orgId
	 * @return
	 */
	...
	/**
	 * query the list of orgnizations ,all were params orgid's children.<br />exclude itself.
	 * @param orgId
	 * @return
	 */
