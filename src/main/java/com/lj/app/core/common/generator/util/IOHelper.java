...
public class IOHelper {
	...
	public static String readFile(File file) {
		try {
			...
			throw new RuntimeException("occer IOException when read file:"
					+ file, e);
		}
	}
	...
	public static void saveFile(File file, String content, String encoding,
		...
		try {
			...
			Writer writer = StringHelper.isBlank(encoding) ? new OutputStreamWriter(
					output) : new OutputStreamWriter(output, encoding);
