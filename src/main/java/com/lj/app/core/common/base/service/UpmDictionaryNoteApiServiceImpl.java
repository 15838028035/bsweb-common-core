...
public class UpmDictionaryNoteApiServiceImpl implements UpmDictionaryNoteApiService {
  ...
  public Map<String, String> findUpmDictionaryListMapBy(String typeCode) {
    ...
    List<UpmDictionary> list = null;
    UpmDictionaryService upmDictionaryService = (UpmDictionaryService) SpringContextHolder
        .getBean("upmDictionaryService");
  ...
  public void setUpmDictionaryNoteService(UpmDictionaryNoteService upmDictionaryNoteService) {
