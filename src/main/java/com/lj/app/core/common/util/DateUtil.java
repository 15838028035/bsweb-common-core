...
public class DateUtil {
	...
	public static Date handleTimeStrToDate(String timeStr, String style)
	...
	public static Timestamp handleTimeStrToTimestamp(String timeStr,
	...
	public static String handleTimestampToTimeStr(Timestamp timestamp,
			String style) {
		if (timestamp == null)
			return null;
	...
	public static String handleDateTimeStyle(String timeStr, String oldStyle,
			String newStyle) {
		Date date = null;
		try {
	...
	public static Timestamp getYearStart(Timestamp stamp,
		...
		return getYearStart(stamp,
				(daysLater == null ? 0 : daysLater.intValue()),
	 ...
	 */
	public static Timestamp addYears(Timestamp stamp,
			int amount) {
	 ...
	 *             if the Timestamp is null
	 */
	public static Timestamp addMonths(Timestamp stamp,
			int amount) {
	...
	// -----------------------------------------------------------------------
	/**
	 * Adds a number of weeks to a Timestamp returning a new object. The
	 * original Timestamp object is unchanged.
	 * 
	 * @param stamp
	 *            the Timestamp, not null
	 ...
	 *             if the Timestamp is null
	 */
	public static Timestamp addWeeks(Timestamp stamp,
			int amount) {
	 ...
	 *             if the Timestamp is null
	 */
	public static Timestamp addDays(Timestamp stamp,
			int amount) {
	...
	// -----------------------------------------------------------------------
	/**
	 * Adds a number of hours to a Timestamp returning a new object. The
	 * original Timestamp object is unchanged.
	 * 
	 * @param stamp
	 *            the Timestamp, not null
	 ...
	 *             if the Timestamp is null
	 */
	public static Timestamp addHours(Timestamp stamp,
			int amount) {
	 ...
	 */
	public static Timestamp addMinutes(Timestamp stamp,
			int amount) {
	...
	// -----------------------------------------------------------------------
	/**
	 * Adds a number of seconds to a Timestamp returning a new object. The
	 * original Timestamp object is unchanged.
	 * 
	 * @param stamp
	 *            the Timestamp, not null
	 ...
	 *             if the stamp is null
	 */
	public static Timestamp addSeconds(Timestamp stamp,
			int amount) {
	...
	// -----------------------------------------------------------------------
	/**
	 * Adds a number of milliseconds to a Timestamp returning a new object. The
	 * original Timestamp object is unchanged.
	 * 
	 * @param stamp
	 *            the Timestamp, not null
	 ...
	 *             if the stamp is null
	 */
	public static Timestamp addMilliseconds(Timestamp stamp,
			int amount) {
	 ...
	 *             if the stamp is null
	 */
	public static Timestamp add(Timestamp stamp,
		...
		Timestamp retStamp = new Timestamp(c.getTime()
				.getTime());
		return retStamp;
	}
	 ...
	 */
	public static Calendar toCalendar(Timestamp stamp, TimeZone timeZone,
			Locale locale) {
	...
	public static int compareTwoDateInSysDate(String date1, String date2) {
		...
		if (calendar3.compareTo(calendar1) < 0) {
			...
			return 1;// 已失效
		} else if (calendar3.compareTo(calendar1) >= 0
				&& calendar3.compareTo(calendar2) <= 0) {
			return 2;// 生效中
		}
		return 2;
	}
