...
public class UpmConfigurationServiceImpl<UpmConfiguration> extends BaseServiceImpl<UpmConfiguration> implements UpmConfigurationService<UpmConfiguration>{
	...
	public  void reloadConfigPro() {
		...
		// 从数据库中获取配置项数据
		List<com.lj.app.core.common.base.model.UpmConfiguration> list = upmConfigurationService.queryForList(new HashMap());
		for (com.lj.app.core.common.base.model.UpmConfiguration obj : list){
			obj = (com.lj.app.core.common.base.model.UpmConfiguration)obj;
