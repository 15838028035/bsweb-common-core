...
public abstract class BaseIbatisDao<E, PK> extends SqlMapClientDaoSupport {
	...
	public List<E> findByExample(E entity, String sortColumns) {
		...
		return getSqlMapClientTemplate().queryForList(getExampleQuery(),
				parameterObject);
	}
	...
	public PK save(Object e) {
		String currentDb = ((CurrentDb) SpringContextHolder
				.getBean("currentDb")).getCurrentDb();
	...
	public Page pageQuery(Page page) {
		...
		List list = getSqlMapClientTemplate().queryForList(getExampleQuery(),
