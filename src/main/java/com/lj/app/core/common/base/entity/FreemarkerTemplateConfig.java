...
public class FreemarkerTemplateConfig extends BaseEntity{
	...
	public String toString() {
		return new ToStringBuilder(this)
			...
			.append("TemplateConent",getTemplateConent())
	...
	public int hashCode() {
		return new HashCodeBuilder()
			.append(getId())
			.append(getTemplateNo())
			.append(getTemplateName())
			.append(getTemplatePath())
			.append(getTemplateConent())
			.append(getTestData())
			.append(getTestEmail())
			.append(getTemplateRemark())
			.toHashCode();
	}
	
	public boolean equals(Object obj) {
		if(obj instanceof FreemarkerTemplateConfig == false) return false;
		if(this == obj) return true;
		FreemarkerTemplateConfig other = (FreemarkerTemplateConfig)obj;
		return new EqualsBuilder()
			.append(getId(),other.getId())
			.append(getTemplateNo(),other.getTemplateNo())
			.append(getTemplateName(),other.getTemplateName())
			.append(getTemplatePath(),other.getTemplatePath())
			.append(getTemplateConent(),other.getTemplateConent())
			.append(getTestData(),other.getTestData())
			.append(getTestEmail(),other.getTestEmail())
			.append(getTemplateRemark(),other.getTemplateRemark())
			.isEquals();
	}
}
