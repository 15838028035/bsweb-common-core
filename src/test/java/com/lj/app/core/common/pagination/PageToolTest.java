...
public class PageToolTest {
	...
	@Test
	public void pageToJsonJQGridWithNoDateFormatTest() {
		List<TestClass1> TestClass1 = new ArrayList<TestClass1>();
		...
		String result = PageTool.pageToJsonJQGridWithNoDateFormat(page);
		assertEquals("{\"total\":5,\"page\":10,\"records\":100,\"rows\":[]}",result);
	}
	...
	@Test
	public void jsonObjectToJsonJQGridExceptionTest() {
		assertEquals(null,PageTool.jsonObjectToJsonJQGrid(null));
	}
